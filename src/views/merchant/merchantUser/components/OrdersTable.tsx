...
const OrdersTable = () => {
    ...
    const { pageIndex, pageSize, sort, query, total } = useAppSelector(
        (state) => state.merchantUserList.data.tableData
    )
    const loading = useAppSelector((state) => state.merchantUserList.data?.loading)

    const data = useAppSelector((state) => state.merchantUserList.data?.merchantUserList)
