...
const operationsDetailsSchema = yup.object().shape({
  ...
  primaryPOCMobile: yup.string().required('Primary POC Mobile is required').min(11,"Mobile number should be 11 digits long").max(11,"Mobile number should be 11 digits long"),
  ...
  secondaryPOCMobile: yup.string().required("Secondary POC Mobile is required").min(11,"Mobile number should be 11 digits long").max(11,"Mobile number should be 11 digits long"),
  ...
  agreementDetailsMobile: yup.string().required('Mobile for Agreement is required').min(11,"Mobile number should be 11 digits long").max(11,"Mobile number should be 11 digits long"),
  ...
  declarationMobile: yup.string().required('Mobile for Declaration is required').min(11,"Mobile number should be 11 digits long").max(11,"Mobile number should be 11 digits long"),
